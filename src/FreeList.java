...
public class FreeList {
    ...
    private String BASEDIR="/home/deepak/JavaProjects/DFSDraft/src/Servers/S";
    private final int SIZE=64*1024;
    private final long fixedOffset=4*1024;
    private final int METADATASIZE=4*1024;

    FreeList(int port,String filename){
        this.BASEDIR+=""+(port%10)+"/";
...
//            System.out.println(this.mt.getFilename());
